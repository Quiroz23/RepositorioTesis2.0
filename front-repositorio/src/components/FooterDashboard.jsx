...
const FooterDashboard = () => {
  return (
    <div>
      ...
      {/* Contenido footer */}
      <div className="grid grid-rows-1 grid-cols-2 justify-between px-32 p-12 w-full h-full">
        <section>
          <img src={IconInacapFooter} className="md:w-[25%]" alt="" />
          <p className="pt-4 underline underline-offset-1">
            Usted se ha identificado como ___________ (Cerrar sesión) Reiniciar
