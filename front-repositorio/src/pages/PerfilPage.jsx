  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-md mx-auto mt-4 bg-white rounded-md p-4 shadow-md">
        ...
        {/* Agregar lista de tesis del usuario con rol de estudiante */}
        <div className="max-w-md mx-auto mt-2 bg-white rounded-md p-4 shadow-md flex ">
          <p>No hay tesis agregadas aun</p> <Link className="ml-1 underline text-blue-600 font-semibold" to={opciones.enlace1[1]}>Agregar Tesis</Link>
